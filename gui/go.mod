module github.com/1amkhush/torrentium/gui
...
require (
	github.com/1amkhush/torrentium v0.0.0
...
replace github.com/1amkhush/torrentium => ..
...
// replace github.com/wailsapp/wails/v2 v2.10.2 => C:\Users\khush\go\pkg\mod
